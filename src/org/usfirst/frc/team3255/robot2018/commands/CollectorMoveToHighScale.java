 ...
 *
 */
public class CollectorMoveToHighScale extends Command {
    ...
    protected void initialize() {
    	Robot.collectorPID.setSetpoint(RobotPreferences.collectorMoveToHighScaleSetpoint());
    ...
    protected boolean isFinished() {
        return (Robot.collector.isTopSwitchClosed() || Robot.collectorPID.onRawTarget());
    }
