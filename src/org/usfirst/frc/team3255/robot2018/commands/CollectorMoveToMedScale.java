 ...
 *
 */
public class CollectorMoveToMedScale extends Command {

    public CollectorMoveToMedScale() {
    ...
    protected void initialize() {
    	Robot.collectorPID.setSetpoint(RobotPreferences.collectorMedScaleSetpoint());
