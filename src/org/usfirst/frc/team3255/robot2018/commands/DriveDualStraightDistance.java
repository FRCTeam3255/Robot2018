 ...
 *
 */
public class DriveDualStraightDistance extends Command {

	double distance;
	String commandName;
	private double expireTime;
	
    public DriveDualStraightDistance(String name, double inches) {
    ...
    protected void execute() {
    	...
    	// Drives 60% of the distance at 80% max speed
    	if(Robot.drivetrain.getEncoderDistance() < distance*0.60) {
    		Robot.drivetrain.arcadeDrive(0.8, Robot.navYawPID.getOutput(), false);
    	}
    	// Drives remaining distance with PID at 50% max speed
    	else {
